...
A responsive web visualization of the solar system that lets users explore planetary information and characteristics. The project is built with **HTML, CSS, and JavaScript** and is deployed as a fully client-side web application.

🔗 **Live Demo:** https://hridyanshkushwaha.github.io/Solar-System/
...
1. Clone the repository  
   ```bash
   git clone https://github.com/Hridyanshkushwaha/Solar-System.git

2. Open the app in your browser
   cd Solar-System
   open index.html   # or double-click in file explorer

Alternatively, view the live hosted version above.

🔍 Learnings & Skills

This project demonstrates:

1. Basic web page structuring with semantic HTML

2. Responsive styling using CSS

3. Organization of planetary data for educational display
